...
EOF
	...
	rename -v "s/openwrt-*-efi/OprX-openwrt11-x86_64-R$OP_VERSION-UEFI-oDFull-squashfs-$sha5/" bin/targets/x86/64*/*.gz || true
	rename -v "s/openwrt-**-efi/OprX-openwrt22-x86_64-R$OP_VERSION-UEFI-oDFull-squashfs-$sha5/" bin/targets/x86/64*/*.gz || true
	rename -v "s/openwrt-x86-64-generic-squashfs-combined-efi/OprX-openwrt33-x86_64-R$OP_VERSION-UEFI-oDFull-squashfs-$sha5/" bin/targets/x86/64*/*.gz || true  #能成功
